...
@section('header', 'Tambah Penugasan Mengajar')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-6">Form Tambah Penugasan Mengajar</h3>

        <form method="POST" action="{{ route('academic.teaching-assignments.store') }}" class="space-y-5">
            @csrf
